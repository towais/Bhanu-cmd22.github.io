...
<!-- Mirrored from wporganic.com/html/weddingdir/listing-singular.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Jun 2021 11:57:19 GMT -->
<head>
<style>
header{
  background:#000000;
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js/bootstrap.min.js" integrity="sha384-Atwg2Pkwv9vp0ygtn1JAojH0nYbwNJLPhwyoVbhoPwBhjQPR5VtM2+xf0Uwh9KtT" crossorigin="anonymous"></script>
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane show active" id="pills-hr-grid" role="tabpanel" aria-labelledby="pills-hr-grid-tab">
                    <div class="owl-carousel owl-theme" id="slider-vendor-single">                        
                        <!-- About Slider Images -->
                        <div class="item" style="background-image: url(<?php echo e(asset('site_assets/img/vendors/vendor_slider_1.jpg')); ?>);">
                            
                        </div>
                        <!-- About Slider Images -->
        
                        <!-- About Slider Images -->
                        <div class="item" style="background-image: url(<?php echo e(asset('site_assets/img/vendors/vendor_slider_2.jpg')); ?>);">
                            
                        </div>
                        <!-- About Slider Images -->
        
                        <!-- About Slider Images -->
                        <div class="item" style="background-image: url(<?php echo e(asset('site_assets/img/vendors/vendor_slider_3.jpg')); ?>);">
                                ...
                                <div class="row vendor-img-gallery">
                                    <div class="col-md-3 mb-0">
                                        <div class="vendor-gallery">
                                            <a href="<?php echo e(asset('site_assets/img/vendors/vendor_img_1.jpg')); ?>" title="Title come here">
                                                <img src="<?php echo e(asset('site_assets/img/vendors/vendor_img_1.jpg')); ?>" class="rounded" alt="">
                                            </a>                                            
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-0">
                                        <div class="vendor-gallery">
                                            <a href="assets/images/vendors/vendor_img_2.jpg" title="Title come here">
                                                <img src="<?php echo e(asset('site_assets/img/vendors/vendor_img_2.jpg')); ?>" class="rounded" alt="">
                                            </a>  
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-0">
                                        <div class="vendor-gallery">
                                            <a href="assets/images/vendors/vendor_img_3.jpg" title="Title come here">
                                                <img src="<?php echo e(asset('site_assets/img/vendors/vendor_img_3.jpg')); ?>" class="rounded" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-0">
                                        <div class="vendor-gallery">
                                            <a href="assets/images/vendors/vendor_img_4.jpg" title="Title come here">
                                                <img src="<?php echo e(asset('site_assets/img/vendors/vendor_img_4.jpg')); ?>" class="rounded" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-3 mb-0">
                                            <div class="vendor-gallery">
                                                <a href="assets/images/vendors/vendor_img_5.jpg" title="Title come here">
                                                    <img src="<?php echo e(asset('site_assets/img/vendors/vendor_img_5.jpg')); ?>" class="rounded" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-3 mb-0">
                                            <div class="vendor-gallery">
                                                <a href="assets/images/vendors/vendor_img_6.jpg" title="Title come here">
                                                    <img src="<?php echo e(asset('site_assets/img/vendors/vendor_img_6.jpg')); ?>" class="rounded" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-3 mb-0">
                                            <div class="vendor-gallery">
                                                <a href="assets/images/vendors/vendor_img_7.jpg" title="Title come here">
                                                    <img src="<?php echo e(asset('site_assets/img/vendors/vendor_img_7.jpg')); ?>" class="rounded" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-shadow-body">
                                <div class="vendor-video">
                                    <a class="popup-video" href="http://www.youtube.com/watch?v=0O2aH4XLbto">
                                        ...
                                        <img src="<?php echo e(asset('site_assets/img/vendors/vendor_video.jpg')); ?>" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-shadow pos-rel">
                            ...
                            <div class="card-shadow-body border-top">
                                ...
                                <div class="reviews-media">
                                    <div class="media">
                                        <img class="thumb" src="<?php echo e(asset('site_assets/img/thumb_img_1.jpg')); ?>" alt="">
                                ...
                                <div class="reviews-media">
                                    <div class="media">
                                        <img class="thumb" src="<?php echo e(asset('site_assets/img/thumb_img_3.jpg')); ?>" alt="">
                                        <div class="media-body">
                                            <div class="heading-wrap no-gutters">
                                                <div class="heading">
                                                    <div class="col pl-0">
                                            ...
                                            <div class="media reply-box">
                                                <img src="<?php echo e(asset('site_assets/img/thumb_img_2.jpg')); ?>" alt="" class="thumb ">
                                                <div class="media-body">
                                ...
                                <div class="reviews-media">
                                    <div class="media">
                                        <img class="thumb" src="<?php echo e(asset('site_assets/img/thumb_img_4.jpg')); ?>" alt="">
                                        <div class="media-body">
                                            <div class="heading-wrap no-gutters">
                                                <div class="heading">
                                                    <div class="col pl-0">
                            ...
                            <div class="sidebar-secondary col-lg-12 col-md-6">
                                ...
                                <div class="widget">
                                    ...
                                    <div class="profile-avatar">
                                        <img src="<?php echo e(asset('site_assets/img/author_profile.jpg')); ?>" alt="">
                                        <div class="content">
                                    ...
                                    <div class="owl-carousel owl-theme" id="wedding-listing-single">                        
                                        ...
                                        <div class="item">
                                            <div class="wedding-listing">
                                                <div class="img">
                                                    <a href="javascript:">
                                                        <img src="<?php echo e(asset('site_assets/img/weddings/wedding_listing_1.jpg')); ?>" alt="">                                                    
                                                    </a>
                                        ...
                                        <div class="item">
                                            <div class="wedding-listing">
                                                <div class="img">
                                                    <a href="javascript:">
                                                        <img src="<?php echo e(asset('site_assets/img/weddings/wedding_listing_2.jpg')); ?>" alt="">
                                                    </a>
                                                    <div class="img-content">
                                                        <div class="top">                                                           
                                                            <span class="featured">
                                        ...
                                        <div class="item">
                                            <div class="wedding-listing">
                                                <div class="img">
                                                    <a href="javascript:">
                                                        <img src="<?php echo e(asset('site_assets/img/weddings/wedding_listing_3.jpg')); ?>" alt="">
                                                    </a>
                                                    <div class="img-content">
                                                        <div class="top">
                                                            <span class="price">
  ...
  <footer id="footer">
                    ...
                    <div class="p-3 px-4 pt-0">
                        <div class="request-quote-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-radio custom-control-inline mb-3">
                                    <input type="radio" id="customRadioInline1_popup" name="customRadioInline1_popup" class="custom-control-input">
                                    <label class="custom-control-label" for="customRadioInline1_popup">Call</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline mb-3">
                                    <input type="radio" id="customRadioInline2_popup" name="customRadioInline1_popup" class="custom-control-input">
                                    <label class="custom-control-label" for="customRadioInline2_popup">Email</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline mb-3">
                                    <input type="radio" id="customRadioInline3_popup" name="customRadioInline1_popup" class="custom-control-input">
                                    <label class="custom-control-label" for="customRadioInline3_popup">Video call</label>
                                </div>
    ...
    <script type="text/javascript" src="<?php echo e(asset('site_assets/assets/library/maps/jquery.gmap.min.js')); ?>"></script> 
    <script src="<?php echo e(asset('site_assets/assets/js/script.js')); ?>"></script>
    
</body>

<!-- Mirrored from wporganic.com/html/weddingdir/listing-singular.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Jun 2021 11:57:52 GMT -->
</html><?php /**PATH D:\xampp\htdocs\laravel\wedding\resources\views/shagun.blade.php ENDPATH**/ ?>