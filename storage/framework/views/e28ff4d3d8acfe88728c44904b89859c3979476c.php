...
<!-- Mirrored from wporganic.com/html/weddingdir/couple-dashboard-todo-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Jun 2021 11:59:15 GMT -->
<head>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="todo-status">
                                        <div class="mr-3"> <strong><small>You have completed 5 out of 80 tasks</small></strong></div>
                                        <div class="progress">
                        ...
                        <div class="upcoming-task">
                            <ul class="list-unstyled">
                                <li>
                                    <div class="d-flex align-items-center">
                                        <div class="custom-control custom-checkbox form-dark">  
                                            <input type="checkbox" class="custom-control-input option-input" id="customCheck1" checked>
                                            <label class="custom-control-label checked-label-text" for="customCheck1">
                                    ...
                                    <div class="info-listing align-items-center">
                                        ...
                                        <div class="badge-wrap text-center">
                                            <span class="d-flex">
                                                <a href="javascript:" class="action-links edit mx-2"><i class="fa fa-pencil"></i></a> 
                                ...
                                <li>
                                    <div class="d-flex align-items-center">
                                        <div class="custom-control custom-checkbox form-dark">
                                            <input type="checkbox" class="custom-control-input option-input" id="customCheck2">
...
<!-- Mirrored from wporganic.com/html/weddingdir/couple-dashboard-todo-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Jun 2021 11:59:15 GMT -->
</html><?php /**PATH D:\xampp\htdocs\laravel\wedding\resources\views/couple_checklist.blade.php ENDPATH**/ ?>